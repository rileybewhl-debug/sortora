...
function payoutNotification(data) {
  ...
  return wrapper(header('Payout Sent')
    ...
    + '<div style="font-size:40px;font-weight:800;color:' + DARK + ';letter-spacing:-1.5px;line-height:1;margin-bottom:8px">;font-weight:500">should arrive in ' + (data.arrivalDays || '2-3') + ' business days</div>'
